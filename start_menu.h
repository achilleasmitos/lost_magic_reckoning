            ...
            case 2:
            {
                ...
                case 2:
                {
                    do
                    {
                        ...
                        if (weight_shoice == 1)
                        {
                            utils::customize_text(utils::text_size, utils::Light);
                            break;
                        }
                        else if (weight_shoice == 2)
                        {
                            utils::customize_text(utils::text_size, utils::SemiLight);
                            break;
                        }
                        else if (weight_shoice == 3)
                        {
                            utils::customize_text(utils::text_size, utils::Normal);
                            break;
                        }
                        else if (weight_shoice == 4)
                        {
                            utils::customize_text(utils::text_size, utils::SemiBold);
                            break;
                        }
                        else if (weight_shoice == 5)
                        {
                            utils::customize_text(utils::text_size, utils::Bold);
                            break;
                        }
                        else
                        {
